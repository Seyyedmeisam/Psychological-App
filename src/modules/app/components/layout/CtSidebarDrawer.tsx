...
export function CtSidebarDrawer() {
  ...
  return (
    <CtDialogRoot open={isMobileOpen} onOpenChange={setMobileOpen}>
      <CtDialogContent className="inset-y-0 inset-s-0 h-dvh max-w-[90vw] translate-x-0 rounded-none border-0 p-0 data-[state=closed]:slide-out-to-left-2 data-[state=open]:slide-in-from-left-2 sm:max-w-sm">
